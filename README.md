...
If you're not using a dependency injection framework like [Dagger](https://github.com/google/dagger/), you can create a simply factory to get the appropriate instance. 
