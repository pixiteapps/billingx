...
class DebugBillingClientTest {
  ...
  val localBroadcastInteractor = object : LocalBroadcastInteractor {
  ...
  @Before fun setup() {
    ...
    client = DebugBillingClient(activity, Executor { command -> command?.run() },
        purchasesUpdatedListener, store, localBroadcastInteractor)
  }
